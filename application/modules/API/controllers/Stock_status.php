 ...
 */
class Stock_status extends \API\Libraries\REST_Controller  {
    ...
    public function index_get()
    {
        ...
        $formulations = $this->stock_status_model->read();
    ...
    {   
        ...
        $data = $this->stock_status_model->insert($data);
        if($data['status'])
        {
            unset($data['status']);
    ...
    {   
        ...
        $data = $this->stock_status_model->update($id, $data);
        if($data['status'])
        {
            unset($data['status']);
            $this->set_response($data, \API\Libraries\REST_Controller::HTTP_CREATED); // CREATED (201) being the HTTP response code
    ...
    public function index_delete()
    {
        ...
        $data = $this->stock_status_model->delete($id);
        if($data['status'])
        {
            unset($data['status']);
            $this->set_response([

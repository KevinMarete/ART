...
$config['reporting_rates_chart_filters'] = array('data_date', 'county', 'sub_county');
...
$config['patients_by_regimen_chart_filters'] = array('data_year', 'data_month', 'county', 'sub_county', 'regimen');
...
$config['drug_consumption_allocation_trend_chart_filters'] = array('data_date', 'county', 'sub_county', 'drug');
...
$config['stock_status_trend_chart_filters'] = array('data_date', 'county', 'sub_county', 'drug');
...
$config['low_mos_commodity_table_filters'] = array('data_year', 'data_month', 'county', 'sub_county', 'drug');
...
$config['high_mos_commodity_table_filters'] = array('data_year', 'data_month', 'county', 'sub_county', 'drug');

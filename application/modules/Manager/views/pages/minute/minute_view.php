    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb page-header">
                <?php if ($this->uri->segment(3) == 'minute') { ?>
                    <li><a href="<?php echo base_url('manager/procurement/minute'); ?>">Procurement</a></li>
                    <li><a href="#">Meeting</a></li>
                    <li class="active breadcrumb-item"><i class="white-text" aria-hidden="true"></i> Commodity Minutes</li>
                <?php } else { ?>

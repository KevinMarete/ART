...
<form id="MINUTES">
    <div class="panel panel-default">
        <div class="panel-heading">Minutes - <?= date('d/m/Y') ?>  || <i class="fa fa-plus-circle loadUsers"> New Minute</i></div>
        <div class="panel-body" style="padding:20px;">
            ...
            <div class="row" style="margin-top:20px;">
                ...
                <p><div class="alert alert-info">Will be filled automatically when sending membrers email***</div></p>
            </div> 
            <div class="row">

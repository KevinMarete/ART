<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            <button class="btn btn-default" onclick="add_status()"><i class="fa fa-plus-square-o"></i> Add Status</button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url('Manager/settings/Status/ajax_list'); ?>",
                "type": "POST"
            },
            "columnDefs": [
                {
    ...
    function edit_status(id)
    {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo base_url('Manager/settings/Status/ajax_edit'); ?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        if (save_method == 'add') {
            url = "<?php echo base_url('Manager/settings/Status/ajax_add'); ?>";
        } else {
            url = "<?php echo base_url('Manager/settings/Status/ajax_update'); ?>";
        }
        $.ajax({
            url: url,
            type: "POST",

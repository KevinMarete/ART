    ...
    public function get_table_data($table) {
        ...
        try {
            if ($table == 'tbl_backup') {
                ...
                $this->db->select('i.id,i.version,UCASE(f.name)facility_name,i.setup_date,i.contact_name,i.contact_phone,i.emrs_used,i.active_patients,IF(`is_internet`=1,"Yes","No"),IF(`is_usage`=1,"Yes","No"),u.firstname user_name');

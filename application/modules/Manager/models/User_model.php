...
class User_model extends CI_Model {
    ...
    public function send_register_details($receipent_name, $email_address, $password) {
        ...
        $this->email->message('Dear ' . $receipent_name . ', <br/> Your account password has been created,<br> email: <b>' . $email_address . '</b><br>Password ' . $password . '<br>Regards,<br>Commodity Manager Team');

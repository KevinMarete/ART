...
class Line extends MX_Controller {
    ...
    public function ajax_list() {
        ...
        foreach ($list as $line) {
            ...
            $row[] = $line->name;
            //add html for action
            $row[] = '<a class="fa fa-pencil" href="javascript:void(0)" title="Edit" onclick="edit_line(' . "'" . $line->id . "'" . ')"></a> |
				  <a class="fa fa-trash" href="javascript:void(0)" title="Delete" onclick="delete_line(' . "'" . $line->id . "'" . ')"></a>';

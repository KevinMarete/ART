...
class Facility extends MX_Controller {
    ...
    public function ajax_list() {
        ...
        foreach ($list as $facility_list) {
            ...
            //add html for action
            $row[] = '<a class ="fa fa-pencil" href="javascript:void(0)" title="Edit" onclick="edit_facility_listing(' . "'" . $facility_list->facility_id . "'" . ')"></a> |
				  <a class="fa fa-trash" href="javascript:void(0)" title="Delete" onclick="delete_facility_listing(' . "'" . $facility_list->facility_id . "'" . ')"></a>';

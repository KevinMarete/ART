...
class Service extends MX_Controller {
    ...
    public function ajax_list() {
        ...
        foreach ($list as $service) {
            ...
            $row[] = $service->name;
            //add html for action
            $row[] = '<a class="fa fa-pencil" href="javascript:void(0)" title="Edit" onclick="edit_service(' . "'" . $service->id . "'" . ')"></a> |
				  <a class="fa fa-trash" href="javascript:void(0)" title="Delete" onclick="delete_service(' . "'" . $service->id . "'" . ')"></a>';

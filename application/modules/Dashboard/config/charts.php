...
$config['patient_by_regimen_filters'] = array('data_month', 'data_year', 'regimen', 'facility', 'sub_county', 'county');
...
$config['stock_status_filters'] = array('data_month', 'data_year', 'drug');
...
$config['national_mos_filters'] = array('data_month', 'data_year', 'drug');
...
$config['patient_in_care_filters'] = array('data_month', 'data_year', 'regimen_category', 'regimen');
...
$config['patient_regimen_category_filters'] = array('data_month', 'data_year', 'facility', 'sub_county', 'county');
...
$config['drugs_in_regimen_filters'] = array('data_month', 'data_year', 'facility', 'sub_county', 'county');

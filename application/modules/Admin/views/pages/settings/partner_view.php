    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <ol class="breadcrumb">
                ...
                <li class="active breadcrumb-item"><i class="fa fa-angle-double-right mx-2 white-text" aria-hidden="true"></i> Partner</li>
            </ol>
        </div>
    </div>
    <div class="panel panel-primary">
        <div class="panel-body">
            <button class="btn btn-primary" onclick="add_partner()"><i class="glyphicon glyphicon-plus"></i> Add Partner</button>
...
<script src="<?php echo base_url() . 'public/admin/js/settings_partner.js'; ?>"></script>
